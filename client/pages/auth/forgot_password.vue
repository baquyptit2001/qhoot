    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <div class="login100-form validate-form flex-sb flex-w" style="padding: 15px">
          ...
          <div style="margin: 15px 0;color: gray; text-align: center">
            We'll send you a link to reset your password to your email if it's exist
          </div>
          ...
          <div style="display:flex; justify-content: space-between;">
            <div>
              Have remember your password?
              <NuxtLink :to="{name: 'auth-login'}">Login</NuxtLink>
            </div>
            <div>
              <NuxtLink :to="{name: 'auth-forgot_password'}" class="txt3">
                Forgot Password?
              </NuxtLink>
            </div>
          </div>
          <div class="container-login100-form-btn" style="margin-top: 15px;">
            <el-button type="success" @click="send" round class="login100-form-btn" v-loading="loading">
              Send
            </el-button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    send() {
      ...
      this.loading = true
      axios.post(API_URL + 'auth/forgot_password', this.user)
          .then(res => {
            ElNotification({
              title: 'Success',
